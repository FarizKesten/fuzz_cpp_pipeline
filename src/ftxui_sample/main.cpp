...
// configuration step. It creates a namespace called `fuzz_cpp_pipeline`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", fuzz_cpp_pipeline::cmake::project_name, fuzz_cpp_pipeline::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", fuzz_cpp_pipeline::cmake::project_version);
      return EXIT_SUCCESS;
    }
